---
name: reference-docs
description: Official documentation links for the ubfb-ui tech stack
metadata:
  type: reference
---
...
- Transloco (signals): https://jsverse.gitbook.io/transloco/core-concepts/signals
- NgRx Signals: https://ngrx.io/guide/signals
- PrimeNG config: https://primeng.org/configuration
- PrimeNG source: https://github.com/primefaces/primeng
